										...
										<div class="row">
											<div class="col-md-12">
												<form>
													...
													<div class="form-group row">
														<label for="collegename" class="col-4 col-form-label">Year, Div</label>
														<div class="col-8">
													...
													<div class="form-group row">
														...
														<div class="col-8">
														<input id="address" name="address" size="40" class="form-control" type="text" value="<%=rs.getString(5)%>" disabled>
														</div>
