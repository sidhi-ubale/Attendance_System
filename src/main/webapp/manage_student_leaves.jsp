...
<body style="background-color:#F0F0F0">
	...
	<div class="container-fluid">
		<div class="panel panel-default shadow p-3 mb-5">
			<div class="panel-body">
				...
				%>
				<div class="alert alert-info shadow p-3 mb-5" style="text-transform: uppercase">Leave Management</div>
				<%
    ...
    <tr>
        ...
        <td>
            <a href="ManageLeaves?id=<%=rs.getInt(1)%>" class="btn btn-primary">Approve Leave</a>
            <a href="reject_student_leaves.jsp?id=<%=rs.getInt(1)%>" class="btn btn-danger">Reject</a>
        </td>
    </tr>
</form>
