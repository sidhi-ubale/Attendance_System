...
<body
	style="background-image: url(images/College.jpeg); background-size: 1500px;">
	<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
		<!-- Brand/logo -->
		 <a
			...
			class="navbar-brand" href="index.jsp"><strong><span class="glyphicon glyphicon-user"></span>&nbsp;Staff Login</strong></a> <a
			...
			class="navbar-brand" href="">&nbsp;</a> <a class="navbar-brand"
			href="">&nbsp;</a> <a class="navbar-brand" href="">&nbsp;</a> <a
			class="navbar-brand" href="">&nbsp;</a> <a>class="navbar-brand"</a>
			</nav>
	<div class="container">

		<div id="loginbox" style="margin-top: 128px;"
			class="mainbox col-md-6  col-sm-6 col-sm-offset-7">
			<div class="panel panel-default shadow p-3 mb-5">
				<!-- <div class="panel-heading">
					<div class="panel-title" style="text-transform: uppercase;font-weight:bold;font-size:1000px;">Admin Sign In</div>
				</div> -->
				<div style="padding-top: 30px" class="panel-body">
					<h3 class="text-center">DYPIMCA STAFF LOGIN</h3>
					<br>
					<%
					...
					%>
					<div class="alert alert-danger" id="danger">You have entered
    ...
    <input id="login-password" type="password" class="form-control" name="password" placeholder="Password" style="height: 30px;" required>
</div>
						...
						<div style="margin-top: 10px" class="form-group">
							...
							<div class="col-sm-8 controls">
								...
								<a href="forgetPassword.jsp" class="btn btn-link ml-auto">Forget password?</a>
						...
						<div class="form-group">
							<div class="col-md-12 control">
								<div
									style="border-top: 1px solid #888; padding-top: 15px; font-size: 120%">
		...
		<div id="signupbox" style="display: none; margin-top: 130px"
			class="mainbox col-md-6  col-sm-6 col-sm-offset-7">
				...
				<div class="panel-body">
					<form id="signupform" class="form-horizontal" role="form"
						...
						<div class="form-group">
							<div class="col-md-12 control">
								<div
									style="border-top: 1px solid #888; padding-top: 15px; font-size: 100%">
