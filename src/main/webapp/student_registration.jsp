	...
	<div class="container-fluid">
		<div class="panel panel-default">
			<div class="panel-body">
				<div class="alert alert-info shadow p-3 mb-5" style="text-transform: uppercase">Student
					Registration</div>
				<%
				...
				%>
				<div class='alert alert-success' id='success'>Student Registered
					Successfully.</div>
				<%
					}
					...
					<div class="panel-body">
						<form action="StudentRegistration" method="post">
							<div class="form-row">
								...
								<div class="form-group col-md-6">
									<label for="collegeName">Year,Division</label> <input
										type="text" class="form-control" id="collegeName"
										name="collegeName" placeholder=" Enter in format: FY/SY, Div A/B/C" required>
								</div>
							</div>
							<div class="form-row">
								<div class="form-group col-md-6">
