	...
	<div class="container-fluid">
		<div class="panel panel-default">
			<div class="panel-body">
				<div class="alert alert-info shadow p-3 mb-5" style="text-transform: uppercase">Modify Details</div>
				<div class="panel panel shadow p-3 mb-5">
					<div class="panel-heading bg-light" style="text-transform: uppercase"><strong>Update Details </strong></div>
					<div class="panel-body">
						<%
						...
						<form action="students_update_process.jsp" method="post">
							...
							<div class="form-group">
								<label for="cname">Year, Div</label> <input type="text"
