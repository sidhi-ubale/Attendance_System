...
<body style="background-color:#F0F0F0";>
	...
	<div class="container-fluid">
		<div class="panel panel-default shadow p-3 mb-5" style="text-transform: uppercase">
			<div class="panel-body">
				<%
					ResultSet resultset = DatabaseConnection
								.getResultFromSqlQuery("select count(*) from student_leave where leave_status='Approved'");
						resultset.next();
						int count = resultset.getInt(1);
				%>
				<div class="alert alert-info shadow p-3 mb-5">Leave Management / Approved
				...
				<div class="panel panel shadow p-3 mb-5">
					<div class="panel-heading bg-light" style="text-transform: uppercase;font-size:small;font-weight: bold;">
						Approved Students Leave Request&nbsp;&nbsp;&nbsp;[&nbsp;<%=(new java.util.Date()).toLocaleString()%>&nbsp;]&nbsp;&nbsp;
						<a class="btn btn-info" href=""><span class="badge"><%=count%></span>
							Approved Request</a>
					</div>
					<div class="panel-body">
								...
								<tbody>
									<%
										ResultSet rs = DatabaseConnection
													.getResultFromSqlQuery("select * from student_leave where leave_status='Approved'");
											while (rs.next()) {
									%>
									<tr>
										<td><%=rs.getInt(1)%></td>
