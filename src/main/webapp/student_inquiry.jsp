	...
	<div class="container-fluid">
		<div class="panel panel-default">
			<div class="panel-body">
				<div class="alert alert-info shadow p-3 mb-5" style="text-transform: uppercase">Enquiry/Complaint</div>
				<%
										...
										<div class="row">
											<div class="col-md-12">
												<form action="StudentQuery" method="post">
													...
													<div class="form-group row">
														<label for="message" class="col-4 col-form-label">Inquiry/Query</label>
														<div class="col-8">
														<textarea id="message" name="message" placeholder="" class="form-control here" rows="4" cols="30"></textarea>
														</div>
