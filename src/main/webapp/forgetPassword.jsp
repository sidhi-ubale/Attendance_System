	...
	<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
		<!-- Brand/logo -->
		 <a
			...
			class="navbar-brand" href="index.jsp">Staff Login</a> <a
		...
		<div id="loginbox" style="margin-top: 50px;"
			...
			<div class="panel panel-danger">
				...
				<div style="padding-top: 30px" class="panel-body">
					...
					%>
					<div class="alert alert-success" id="success">Your login user name and password send successfully in your email.</div>
					<%
						}
					%>
