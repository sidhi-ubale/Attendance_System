...
<body style="background-image:url(images/student1.jpg);background-size:999px;">
	<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
		<!-- Brand/logo -->
		 <a
			...
			class="navbar-brand" href="">&nbsp;</a> <a class="navbar-brand"
			href="">&nbsp;</a><a class="navbar-brand" href="">&nbsp;</a> <a
			class="navbar-brand ml-auto" href=""><strong></strong></a>

		<!-- Links -->
	</nav>
	<div class="container">
		<img src="images/logo.png"  class="rounded float-right" alt="Cinque Terre"
			width="380" height="106"> 
		<div id="loginbox" style="margin-top: 50px;"
			...
			<div class="panel panel-danger shadow p-3 mb-5">
				...
				<h3 class="text-center">DYPIMCA STUDENT LOGIN</h3><br>
					<%
