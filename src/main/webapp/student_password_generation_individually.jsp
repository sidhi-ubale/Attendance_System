	...
	<div class="container-fluid">
		<div class="panel panel-default shadow p-3 mb-5">
			<div class="panel-body">
				<div class="alert alert-info shadow p-3 mb-5" style="text-transform: uppercase">Students
					Password Generation Individually</div>
				<%
						...
						<table id="table"
							...
							<tbody>
								...
								<tr>
									...
									<td><a
										href="PasswordGenerationIndividually?studId=<%=rs.getInt(1)%>"
										class="btn btn-primary"><i class="fa fa-spinner fa-spin"></i>
											Generate Password</a></td>
								</tr>
								<%
									}
								%>
