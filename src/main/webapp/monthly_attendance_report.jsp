		...
		<div class="panel panel-default shadow p-3 mb-5">
			<div class="panel-body">
				<div class="alert alert-info shadow p-3 mb-5"
					style="text-transform: uppercase">Attendance Reports /
				...
				<div class="panel panel shadow p-3 mb-5">
					<div class="panel-heading bg-light"
						...
						Monthly Attendance Report&nbsp;&nbsp;&nbsp;[&nbsp;<%=(new java.util.Date()).toLocaleString()%>&nbsp;]&nbsp;&nbsp;
					</div>
					<div class="panel-body">
						<form action="monthly_attendance_report.jsp" method="post">
							<div class="form-row">
								...
								<div class="form-group col-md-4">
									<input type="date" class="form-control" id="sdate" name="edate">
								</div>
							...
							<table id="table" class="table table-bordered">
								...
								<tbody>
									...
									<tr>
										<td>&nbsp;</td>
										<td>&nbsp;</td>
										<td>No attendance found between two dates.</td>
										<td>&nbsp;</td>
									</tr>
									<%
										}
