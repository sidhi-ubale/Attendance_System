	...
	<div class="container-fluid">
		<div class="panel panel-default shadow p-3 mb-5">
			<div class="panel-body">
				<div class="alert alert-info shadow p-3 mb-5" style="text-transform: uppercase">Students Activity / Send User
					Name & Password Email to Students</div>
				<%
				...
				<div class="panel panel shadow p-3 mb-5">
					<div class="panel-heading bg-light" style="text-transform: uppercase;font-size:small;font-weight: bold;">
						Send User Name & Password in Mail&nbsp;&nbsp;&nbsp;[&nbsp;<%=(new java.util.Date()).toLocaleString()%>&nbsp;]&nbsp;&nbsp;
					</div>
					<div class="panel-body">
						<table id="table"
							...
							<thead>
								<tr>
									...
									<th>Send User Name & Password in Mail</th>
								</tr>
							</thead>
							<tbody>
								<%
